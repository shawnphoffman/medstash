...
export const receiptsApi = {
	...
	addFiles: (
		id: number,
		files: File[],
		receiptData?: { date?: string; user?: string; vendor?: string; amount?: number; type?: string }
	) => {
		const formData = new FormData()
		files.forEach(file => formData.append('files', file))
...
export const flagsApi = {
	...
	update: (id: number, data: Partial<CreateFlagInput>) => api.put<Flag>(`/flags/${id}`, data),
...
export const receiptTypeGroupsApi = {
	...
	update: (id: number, data: UpdateReceiptTypeGroupInput) => api.put<ReceiptTypeGroup>(`/receipt-type-groups/${id}`, data),
...
export const receiptTypesApi = {
	...
	update: (id: number, data: UpdateReceiptTypeInput) => api.put<ReceiptType>(`/receipt-types/${id}`, data),
...
export const settingsApi = {
	...
	set: (key: string, value: any) => api.put<{ key: string; value: any }>(`/settings/${key}`, { value }),
}
